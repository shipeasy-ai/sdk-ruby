  ...
  class AlertsApi
    ...
    def delete_alert_rule_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AlertsApi.delete_alert_rule"
      end
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling AlertsApi.delete_alert_rule, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling AlertsApi.delete_alert_rule, the character length must be greater than or equal to 1.'
      end
    ...
    def list_alert_rules_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'q'].nil? && opts[:'q'].to_s.length > 100
        fail ArgumentError, 'invalid value for "opts[:"q"]" when calling AlertsApi.list_alert_rules, the character length must be smaller than or equal to 100.'
      end
    ...
    def update_alert_rule_with_http_info(id, update_alert_rule_request, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling AlertsApi.update_alert_rule, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling AlertsApi.update_alert_rule, the character length must be greater than or equal to 1.'
      end
