...
module Shipeasy::Admin::Generated
  class ConfigsApi
    ...
    # Creates a new config with the given `schema`. The initial `value` (or an empty object) is published as version 1 on **every** env.  Returns `409` if `name` already exists in the project, `400` if `value` doesn't validate against `schema`.  **Use cases**  - **Minimal create** — `name` + `schema`. Initial value defaults to `{}`. - **Seeded create** — supply a flat `value` to publish the same object on every env. - **Per-env seed** — supply a `{ env: value }` map under `value`, or pass the env keys `dev`/`staging`/`prod` directly (each overrides `value` for that env and is published at version 1).
    ...
    def delete_config_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.delete_config, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.delete_config, the character length must be greater than or equal to 1.'
      end
    ...
    def discard_config_draft_with_http_info(id, discard_config_draft_request, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.discard_config_draft, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.discard_config_draft, the character length must be greater than or equal to 1.'
      end
    ...
    def get_config_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.get_config, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.get_config, the character length must be greater than or equal to 1.'
      end
    ...
    def list_config_activity_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.list_config_activity, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.list_config_activity, the character length must be greater than or equal to 1.'
      end
    ...
    # Returns every published version of the config's value on one env, newest first. The `env` query parameter picks the environment (`dev`, `staging`, or `prod`) and defaults to `prod`; an unknown env returns `400`. The config's JSON Schema is config-level and not versioned — this is value history only.  **Use case:** Render the History timeline in the config detail pane (value diff + restore), or audit which value was live on prod at a given version.
    # @param id [String] Stable opaque config id (&#x60;cfg_…&#x60;) or the config&#39;s &#x60;name&#x60;.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_project_id Project the request operates on. Optional — defaults to the project the SDK key belongs to; pass it only to scope a multi-project key (the generated client sets it once from its configuration, so per-call callers never thread it).
    # @option opts [Env] :env Environment to list history for (&#x60;dev&#x60;, &#x60;staging&#x60;, or &#x60;prod&#x60;). Defaults to &#x60;prod&#x60; when omitted.
    # @return [Array<ListConfigVersionsResponseInner>]
    def list_config_versions(id, opts = {})
      data, _status_code, _headers = list_config_versions_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :x_project_id Project the request operates on. Optional — defaults to the project the SDK key belongs to; pass it only to scope a multi-project key (the generated client sets it once from its configuration, so per-call callers never thread it).
    # @option opts [Env] :env Environment to list history for (&#x60;dev&#x60;, &#x60;staging&#x60;, or &#x60;prod&#x60;). Defaults to &#x60;prod&#x60; when omitted.
    # @return [Array<(Array<ListConfigVersionsResponseInner>, Integer, Hash)>] Array<ListConfigVersionsResponseInner> data, response status code and response headers
    def list_config_versions_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConfigsApi.list_config_versions ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ConfigsApi.list_config_versions"
      end
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.list_config_versions, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.list_config_versions, the character length must be greater than or equal to 1.'
      end

      # resource path
      local_var_path = '/api/admin/configs/{id}/versions'.sub('{id}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<ListConfigVersionsResponseInner>'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerSdkKey']

      new_options = opts.merge(
        :operation => :"ConfigsApi.list_config_versions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConfigsApi#list_config_versions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_configs_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'q'].nil? && opts[:'q'].to_s.length > 100
        fail ArgumentError, 'invalid value for "opts[:"q"]" when calling ConfigsApi.list_configs, the character length must be smaller than or equal to 100.'
      end
    ...
    def publish_config_draft_with_http_info(id, publish_config_draft_request, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.publish_config_draft, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.publish_config_draft, the character length must be greater than or equal to 1.'
      end
    ...
    def save_config_draft_with_http_info(id, save_config_draft_request, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.save_config_draft, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.save_config_draft, the character length must be greater than or equal to 1.'
      end
    ...
    # Partial update. When `value` is supplied it is **republished on every env** (new version per env). A per-env key (`dev`/`staging`/`prod`) publishes a new version to **only that env**, immediately, overriding `value` for it. When `schema` is supplied it replaces the current schema; every existing value is re-validated.  **Use cases**  - **Republish flat value** — `{ \"value\": {…} }` sets the same value on every env. - **Publish one env** — `{ \"prod\": {…} }` publishes a new version to prod only, instantly. - **Schema migration** — `{ \"schema\": {…} }` replaces the schema; existing values are re-validated.
    # @param id [String] Stable opaque config id (&#x60;cfg_…&#x60;) or the config&#39;s &#x60;name&#x60;.
    ...
    def update_config_with_http_info(id, update_config_request, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.update_config, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.update_config, the character length must be greater than or equal to 1.'
      end
    ...
    def update_config_schema_with_http_info(id, update_config_schema_request, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.update_config_schema, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConfigsApi.update_config_schema, the character length must be greater than or equal to 1.'
      end
