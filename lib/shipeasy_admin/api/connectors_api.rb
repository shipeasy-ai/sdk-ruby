  ...
  class ConnectorsApi
    ...
    def delete_connector_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConnectorsApi.delete_connector, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConnectorsApi.delete_connector, the character length must be greater than or equal to 1.'
      end
    ...
    def fire_connector_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConnectorsApi.fire_connector, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConnectorsApi.fire_connector, the character length must be greater than or equal to 1.'
      end
    ...
    def get_connector_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ConnectorsApi.get_connector"
      end
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConnectorsApi.get_connector, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConnectorsApi.get_connector, the character length must be greater than or equal to 1.'
      end
    ...
    def list_connectors_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'q'].nil? && opts[:'q'].to_s.length > 100
        fail ArgumentError, 'invalid value for "opts[:"q"]" when calling ConnectorsApi.list_connectors, the character length must be smaller than or equal to 100.'
      end
    ...
    def test_connector_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConnectorsApi.test_connector, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConnectorsApi.test_connector, the character length must be greater than or equal to 1.'
      end
    ...
    def update_connector_with_http_info(id, update_connector_request, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConnectorsApi.update_connector, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConnectorsApi.update_connector, the character length must be greater than or equal to 1.'
      end
    ...
    # @param id [String] Stable opaque connector id. Its stored &#x60;provider&#x60; must match the body&#39;s &#x60;provider&#x60;.
    # @param update_trigger_connector_request [UpdateTriggerConnectorRequest] 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_project_id Project the request operates on. Optional — defaults to the project the SDK key belongs to; pass it only to scope a multi-project key (the generated client sets it once from its configuration, so per-call callers never thread it).
    # @return [UpdateConnectorResponse]
    def update_trigger_connector(id, update_trigger_connector_request, opts = {})
      data, _status_code, _headers = update_trigger_connector_with_http_info(id, update_trigger_connector_request, opts)
      data
    end
    ...
    # @option opts [String] :x_project_id Project the request operates on. Optional — defaults to the project the SDK key belongs to; pass it only to scope a multi-project key (the generated client sets it once from its configuration, so per-call callers never thread it).
    # @return [Array<(UpdateConnectorResponse, Integer, Hash)>] UpdateConnectorResponse data, response status code and response headers
    def update_trigger_connector_with_http_info(id, update_trigger_connector_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConnectorsApi.update_trigger_connector ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ConnectorsApi.update_trigger_connector"
      end
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ConnectorsApi.update_trigger_connector, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ConnectorsApi.update_trigger_connector, the character length must be greater than or equal to 1.'
      end

      # verify the required parameter 'update_trigger_connector_request' is set
      if @api_client.config.client_side_validation && update_trigger_connector_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_trigger_connector_request' when calling ConnectorsApi.update_trigger_connector"
      end
      # resource path
      local_var_path = '/api/admin/connectors/{id}/trigger'.sub('{id}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_trigger_connector_request)
      ...
      new_options = opts.merge(
        :operation => :"ConnectorsApi.update_trigger_connector",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConnectorsApi#update_trigger_connector\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
