  ...
  class ErrorsApi
    ...
    def file_error_ticket_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ErrorsApi.file_error_ticket, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ErrorsApi.file_error_ticket, the character length must be greater than or equal to 1.'
      end
    ...
    def get_error_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ErrorsApi.get_error"
      end
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ErrorsApi.get_error, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ErrorsApi.get_error, the character length must be greater than or equal to 1.'
      end
    ...
    def get_error_series_with_http_info(id, error_series_request, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ErrorsApi.get_error_series, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ErrorsApi.get_error_series, the character length must be greater than or equal to 1.'
      end
    ...
    # @option opts [String] :x_project_id Project the request operates on. Optional — defaults to the project the SDK key belongs to; pass it only to scope a multi-project key (the generated client sets it once from its configuration, so per-call callers never thread it).
    # @return [ErrorRecord]
    def resolve_error(id, opts = {})
      data, _status_code, _headers = resolve_error_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :x_project_id Project the request operates on. Optional — defaults to the project the SDK key belongs to; pass it only to scope a multi-project key (the generated client sets it once from its configuration, so per-call callers never thread it).
    # @return [Array<(ErrorRecord, Integer, Hash)>] ErrorRecord data, response status code and response headers
    def resolve_error_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ErrorsApi.resolve_error ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ErrorsApi.resolve_error"
      end
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ErrorsApi.resolve_error, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ErrorsApi.resolve_error, the character length must be greater than or equal to 1.'
      end

      # resource path
      local_var_path = '/api/admin/errors/{id}/resolve'.sub('{id}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ErrorsApi.resolve_error",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ErrorsApi#resolve_error\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_error_status_with_http_info(id, update_error_status_request, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling ErrorsApi.update_error_status, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling ErrorsApi.update_error_status, the character length must be greater than or equal to 1.'
      end
