  ...
  class EventsApi
    ...
    def approve_event_with_http_info(id, approve_event_request, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling EventsApi.approve_event, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling EventsApi.approve_event, the character length must be greater than or equal to 1.'
      end
    ...
    def delete_event_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling EventsApi.delete_event, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling EventsApi.delete_event, the character length must be greater than or equal to 1.'
      end
    ...
    def get_event_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling EventsApi.get_event, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling EventsApi.get_event, the character length must be greater than or equal to 1.'
      end
    ...
    def list_events_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'q'].nil? && opts[:'q'].to_s.length > 100
        fail ArgumentError, 'invalid value for "opts[:"q"]" when calling EventsApi.list_events, the character length must be smaller than or equal to 100.'
      end
    ...
    def update_event_with_http_info(id, update_event_request, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling EventsApi.update_event, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling EventsApi.update_event, the character length must be greater than or equal to 1.'
      end
