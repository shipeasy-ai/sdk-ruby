  ...
  class KillswitchApi
    ...
    def delete_killswitch_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling KillswitchApi.delete_killswitch, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling KillswitchApi.delete_killswitch, the character length must be greater than or equal to 1.'
      end
    ...
    def set_killswitch_value_with_http_info(id, set_killswitch_value_request, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling KillswitchApi.set_killswitch_value, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling KillswitchApi.set_killswitch_value, the character length must be greater than or equal to 1.'
      end
    ...
    def update_killswitch_with_http_info(id, update_killswitch_request, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 128
        fail ArgumentError, 'invalid value for "id" when calling KillswitchApi.update_killswitch, the character length must be smaller than or equal to 128.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling KillswitchApi.update_killswitch, the character length must be greater than or equal to 1.'
      end
