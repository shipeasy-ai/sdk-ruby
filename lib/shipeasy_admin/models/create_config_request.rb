  ...
  class CreateConfigRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'dev' => :'Hash<String, Object>',
        :'staging' => :'Hash<String, Object>',
        :'prod' => :'Hash<String, Object>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'dev')
        if (value = attributes[:'dev']).is_a?(Hash)
          self.dev = value
        end
      end

      if attributes.key?(:'staging')
        if (value = attributes[:'staging']).is_a?(Hash)
          self.staging = value
        end
      end

      if attributes.key?(:'prod')
        if (value = attributes[:'prod']).is_a?(Hash)
          self.prod = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      pattern = Regexp.new(/^(?:_default|[a-z0-9](?:[a-z0-9_-]*[a-z0-9])?)\.[a-z0-9](?:[a-z0-9_-]*[a-z0-9])?$/)
      if @name !~ pattern
    ...
    def valid?
      ...
      return false if @name !~ Regexp.new(/^(?:_default|[a-z0-9](?:[a-z0-9_-]*[a-z0-9])?)\.[a-z0-9](?:[a-z0-9_-]*[a-z0-9])?$/)
    ...
    def hash
      [name, description, folder, schema, value, dev, staging, prod].hash
    end
