  ...
  class CreateEventRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'folder' => :'String',
        :'description' => :'String',
        :'properties' => :'Array<CreateEventRequestPropertiesInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Shipeasy::Admin::Generated::CreateEventRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Shipeasy::Admin::Generated::CreateEventRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      pattern = Regexp.new(/^[a-zA-Z0-9_][a-zA-Z0-9_\-.]{0,49}$/)
      if @name !~ pattern
    ...
    def valid?
      ...
      return false if @name !~ Regexp.new(/^[a-zA-Z0-9_][a-zA-Z0-9_\-.]{0,49}$/)
    ...
    def hash
      [name, folder, description, properties].hash
    end
