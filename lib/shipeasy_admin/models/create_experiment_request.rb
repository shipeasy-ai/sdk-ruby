...
module Shipeasy::Admin::Generated
  ...
  class CreateExperimentRequest < ApiModelBase
    ...
    def valid?
      ...
      return false if !@reserved_headroom.nil? && @reserved_headroom > 10000
      return false if !@reserved_headroom.nil? && @reserved_headroom < 0
    ...
    def hash
      [name, description, hypothesis, tag, owner_email, audience, bucket_by, folder, universe, targeting_gate, holdout_gate, allocation_pct, allocation_percent, reserved_headroom, salt, params, groups, significance_threshold, min_runtime_days, min_sample_size, sequential_testing, goal_metric, guardrail_metrics].hash
    end
