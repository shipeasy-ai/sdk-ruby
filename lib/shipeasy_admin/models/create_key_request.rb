...
module Shipeasy::Admin::Generated
  ...
  class CreateKeyRequest < ApiModelBase
    ...
    def list_invalid_properties
      ...
      if !@name.nil? && @name.to_s.length > 160
        invalid_properties.push('invalid value for "name", the character length must be smaller than or equal to 160.')
      end
    ...
    def valid?
      ...
      return false if !@name.nil? && @name.to_s.length > 160
    ...
    def name=(name)
      ...
      if name.to_s.length > 160
        fail ArgumentError, 'invalid value for "name", the character length must be smaller than or equal to 160.'
      end
