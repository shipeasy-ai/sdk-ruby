  ...
  class CreateMetricRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'min_detectable_effect')
        ...
        self.min_detectable_effect = nil
      end
    ...
    def list_invalid_properties
      ...
      if @winsorize_pct.nil?
        invalid_properties.push('invalid value for "winsorize_pct", winsorize_pct cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @winsorize_pct.nil?
      return false if @winsorize_pct > 99
      return false if @winsorize_pct < 1
