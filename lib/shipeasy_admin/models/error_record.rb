  ...
  class ErrorRecord < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'caused_by_fingerprint')
        ...
        self.caused_by_fingerprint = nil
      end
    ...
    def hash
      [id, project_id, fingerprint, caused_by_fingerprint, message, error_type, stack, source, url, seen_urls, subject, outcome, side, env, kind, last_extras_json, sdk_version, count, occurrences, status, first_seen_at, last_seen_at, created_at, updated_at, assignee_id, assignee_connector_id, assignee_agent].hash
    end
