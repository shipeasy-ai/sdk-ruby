...
module Shipeasy::Admin::Generated
  ...
  class ExperimentInlineMetric < ApiModelBase
    ...
    attr_accessor :min_effect_of_interest
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'min_effect_of_interest')
        self.min_effect_of_interest = attributes[:'min_effect_of_interest']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          value == o.value &&
          min_effect_of_interest == o.min_effect_of_interest
    end
    ...
    def hash
      [name, query, event, aggregation, value, min_effect_of_interest].hash
    end
