...
module Shipeasy::Admin::Generated
  ...
  class GateApiRowStackInnerOneOf < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'bucket_by' => :'String',
        :'salt' => :'String',
        :'ramp' => :'GateApiRowStackInnerOneOfRamp',
        :'locked' => :'Boolean',
        :'whitelist' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Shipeasy::Admin::Generated::GateApiRowStackInnerOneOf` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Shipeasy::Admin::Generated::GateApiRowStackInnerOneOf`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, type, name, from_template, pass, rules, rollout_pct, bucket_by, salt, ramp, locked, whitelist].hash
    end
