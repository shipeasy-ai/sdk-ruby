...
module Shipeasy::Admin::Generated
  ...
  class GetOpsItemResponse < ApiModelBase
    ...
    def hash
      [id, number, type, title, status, priority, source, source_ref, investigation_state, reporter_email, steps_to_reproduce, actual_result, expected_result, description, use_case, context, attachments, related, connector_data, notify, assignee_id, assignee_connector_id, assignee_agent, owner, created_at, updated_at].hash
    end
