...
module Shipeasy::Admin::Generated
  # One typed property on a catalogued event — declared by an admin, or discovered in traffic and awaiting declaration.
  class ListEventsResponseInnerPropertiesInner < ApiModelBase
    ...
    def hash
      [name, type, required, description, pending].hash
    end
