...
module Shipeasy::Admin::Generated
  ...
  class ListMetricsResponseInner < ApiModelBase
    ...
    def hash
      [id, name, folder, event_name, query, query_ir, display_name, preset_id, unit, version, deleted_at, creator_email, updater_email, direction, winsorize_pct, default_min_effect_of_interest, created_at, updated_at].hash
    end
