  ...
  class PushI18nKeysResponse < ApiModelBase
    ...
    def list_invalid_properties
      ...
      if @updated_count.nil?
        invalid_properties.push('invalid value for "updated_count", updated_count cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @updated_count.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] updated_count Value to be assigned
    def updated_count=(updated_count)
      if updated_count.nil?
        fail ArgumentError, 'updated_count cannot be nil'
      end
    ...
    def hash
      [added, skipped, updated, pushed_count, skipped_count, updated_count].hash
    end
