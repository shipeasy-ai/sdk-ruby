...
module Shipeasy::Admin::Generated
  ...
  class RevokeKeyResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Shipeasy::Admin::Generated::RevokeKeyResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Shipeasy::Admin::Generated::RevokeKeyResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      revoked_validator = EnumAttributeValidator.new('Boolean', ["true"])
      return false unless revoked_validator.valid?(@revoked)
      true
    end
    ...
    # @param [Object] revoked Object to be assigned
    def revoked=(revoked)
      validator = EnumAttributeValidator.new('Boolean', ["true"])
      unless validator.valid?(revoked)
        fail ArgumentError, "invalid value for \"revoked\", must be one of #{validator.allowable_values}."
      end
      @revoked = revoked
    end
