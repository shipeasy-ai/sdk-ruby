...
module Shipeasy::Admin::Generated
  ...
  class UpdateExperimentRequest < ApiModelBase
    ...
    def hash
      [name, description, hypothesis, tag, owner_email, audience, bucket_by, folder, targeting_gate, holdout_gate, allocation_pct, reserved_headroom, allocation_percent, salt, universe, params, groups, significance_threshold, min_runtime_days, min_sample_size, sequential_testing, goal_metric, guardrail_metrics].hash
    end
