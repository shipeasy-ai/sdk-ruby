...
module Shipeasy::Admin::Generated
  class UpsertI18nKeysRequestKeysInner < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Shipeasy::Admin::Generated::UpsertI18nKeysRequestKeysInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Shipeasy::Admin::Generated::UpsertI18nKeysRequestKeysInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@variables.nil? && @variables.length > 32
        invalid_properties.push('invalid value for "variables", number of items must be less than or equal to 32.')
      end
    ...
    def valid?
      ...
      return false if !@variables.nil? && @variables.length > 32
      true
    end
    ...
    def variables=(variables)
      ...
      if variables.length > 32
        fail ArgumentError, 'invalid value for "variables", number of items must be less than or equal to 32.'
      end
    ...
    def hash
      [key, value, description, variables].hash
    end
